...
export default function TeamPicker() {
  ...
  const generate = () => {
    ...
    setTeams([[...lockedT0, ...b0], [...lockedT1, ...b1]]);
    setShuffles(s => s + 1);
    setSaved(false);
  };
  ...
  if (loading) return <div className="min-h-screen bg-brand-dark flex items-center justify-center"><p className="text-gray-400">Loading players...</p></div>;
